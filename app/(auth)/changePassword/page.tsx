  ...
  return (
    <div style={{
     ...
     className="min-h-screen bg-[#0B101B] text-white">
      ...
      <main className="flex flex-col items-center justify-center mt-20">
        <h2 className="text-4xl text-[60px]  leading-[50px] font-bold bg-gradient-to-r p-6 from-[#EB568E] to-[#144EE3] text-transparent bg-clip-text text-center mb-6">
          Change Your Password
        </h2>
        <form className="w-2/3 text-center" onSubmit={handleSubmit}>
          ...
          <button
            className="bg-[#144EE3]  h-[60px] w-[260px] text-[#FFFFFF] font-semibold text-[16px] py-[21px] px-[25.05px] border border-solid border-[#144EE3] shadow-[10px_9px_22px_0px_#144EE361] rounded-[48px] "
            type="submit"
            disabled={loading}
          >
