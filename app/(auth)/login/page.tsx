  ...
  return (
    <>
      <div   style={{
        ...
        <p className="text-[#FFFFFF80] font-light text-[14px] text-left flex-none  ">®</p> 
          <h2 className=" text-center flex-1 bg-gradient-to-r from-[#EB568E] to-[#144EE3] text-transparent bg-clip-text font-extrabold text-[36.91px] leading-[45.44px]">
            Linkly
          </h2>
        ...
        <div className="text-center flex  flex-col items-center  ">
          <h1 className="text-[60px] py-[20px] lg:h-[81px] lg:w-[966px] mb-[20px] xs:text-[35px] font-extrabold  sm:text-[35px] 
          ...
          <p className="text-[#C9CED6] mb-[46px] text-[16px] font-light leading-[23.5px] xs:px-[20px]">
